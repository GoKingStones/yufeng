CREATE TABLE `fast_consumer_loan_order_commodity_table` (
  ...
  `user_internal_code` varchar(100) DEFAULT NULL COMMENT '用户内码',
  `seller_internal_code` varchar(100) DEFAULT NULL COMMENT '商户内码',
  `total_amount` decimal(50,2) DEFAULT NULL COMMENT '总金额',
  `information_state` varchar(10) DEFAULT NULL COMMENT '信息状态',
