...
//    }
    ...
    @Test
    public void testUpdateUserBasicInfoByInternalCode() throws Exception {
    	
    	RestTemplate restTemplate = new RestTemplate();
    	UserBasicInfo userBasicInfo = new UserBasicInfo();
    	
    	userBasicInfo.setInternalCode("MDk2MDgzMzU4NzI2NTQwMDg4Nw==");
    	userBasicInfo.setIdType("0");
    	userBasicInfo.setIdNo("120104198408175117");
    	userBasicInfo.setName("于漂亮");
    	
    	
    	HttpEntity<UserBasicInfo> httpEntity=new HttpEntity<UserBasicInfo>(userBasicInfo);
    	ResponseEntity<ResultModel> resultModelResponseEntity = restTemplate.exchange(REST_SERVICE_URI + "/userBasicInfo/updateUserBasicInfo",
              HttpMethod.POST,
              httpEntity,
              ResultModel.class);
