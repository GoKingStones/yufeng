...
//
        ...
        registerAccount.setSource("C");
        String ret =doPost(url,JSON.toJSONString(registerAccount));
        ResultModel resultModel= JSON.parseObject(ret, ResultModel.class);
        System.out.println(resultModel.getMessage());
    }

    public static void testGet() throws Exception {

        String url = REST_SERVICE_URI + "/registerAccount/isExistedRegisterAccount?accountName=ROOT1";
        String ret = doGet(url,"utf-8");
        ResultModel resultModel= JSON.parseObject(ret, ResultModel.class);
        System.out.println(resultModel.getMessage());
    }
    ...
    public static String doPost(String url,String json){
        ...
        try {
            StringEntity s = new StringEntity(json.toString(),"application/json","UTF-8");
